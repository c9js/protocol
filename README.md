...
└── engines/
    ...
    │   ├── logic/
    │   │   ├── loader.js     # Логика загрузки списка каналов связи
    │   │   └── factory.js    # Логика инициализации канала связи
    │   │
    │   └── l2raw/            # Канал связи на уровне L2
    │       ├── init.js       # Логика инициализации канала связи
    │       ├── scanner.js    # Логика списков адаптеров приемника
    │       └── sender.js     # Логика списков адаптеров передатчика
    │
    └── io/
