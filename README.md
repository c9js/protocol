...
│
├── contracts/
│   ├── methods.js            # Контракт методов
│   └── events.js             # Контракт событий
│
└── engines/
    ├── event/
    │   ├── event-engine.js   # Движок событий
    │   ├── logic/
    │   │   └── factory.js    # Логика инициализации событий
    │   │
    │   └── interfaces/
    │       ├── iProtocol.js  # Интерфейс протокола
    │       ├── iScanner.js   # Интерфейс приемника
    │       └── iSender.js    # Интерфейс передатчика
    │
    ├── error/
