...
/*┌─────────────┐
  ...
  └─────────────┘*/
    ...
    // Запускаем отправку пакетов инициализации
        this.runSendCycle('INIT');
    }
...
/*┌─────────────────────────────────────┐
  ...
  └─────────────────────────────────────┘*/
    getNodeIdBuffer = () => {
        return this.syncEngine.getNodeIdBuffer();
    }
...
/*┌──────────────────────────────────────┐
  ...
  └──────────────────────────────────────┘*/
    getPacketIdBuffer = (type) => {
        return this.syncEngine.getPacketIdBuffer(type);
    }
    
/*┌──────────────────────────────────┐
  │ Возвращает текущую позицию байта │
  └──────────────────────────────────┘*/
    getBytePosition = (type, index, offset) => {
        return this.syncEngine.getBytePosition(type, index, offset);
    }
...
/*┌──────────────────────────────┐
  ...
  └──────────────────────────────┘*/
    clearPending = () => {
        this.senderEngine.clearPending();
    }
...
/*┌───────────────────────────────────────────┐
  ...
  └───────────────────────────────────────────┘*/
    runSendCycle = (type) => {
        this.senderEngine.runSendCycle(type);
    }
